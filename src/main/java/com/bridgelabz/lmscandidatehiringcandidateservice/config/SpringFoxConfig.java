package com.bridgelabz.lmscandidatehiringcandidateservice.config;
 ...
 * Version: 3.0
 * @author: Annu Kumari
 * @Visit Link: http://localhost:8084/swagger-ui/
 *
 * */
   ...
   public Docket api() {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.lmscandidatehiringcandidateservice"))
   ...
   /*private ApiInfo getApiInfo() {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfo("Learner Management System",
                ...
                new Contact("Learner Management System", "http://bridgelabz.com&quot", "annusinghraj1998@gmail.com"),
